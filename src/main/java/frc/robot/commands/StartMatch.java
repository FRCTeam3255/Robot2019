...
public class StartMatch extends CommandGroup {
  ...
  private static SN_DoublePreference d4SetPoint = new SN_DoublePreference("D3SetPoint", 24.0);
  private static SN_DoublePreference d4Tolerance = new SN_DoublePreference("D3Tolerance", 4.0);
  ...
  public StartMatch() {
    ...
    d1.getPID().setTolerence(d1Tolerance);
