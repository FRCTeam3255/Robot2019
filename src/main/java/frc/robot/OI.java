...
public class OI {
	...
	public OI() {
		...
		manipulatorStick.btn_7.whenPressed(new CascadeMove(new SN_DoublePreference("hatchPos3", 51.0)));
		manipulatorStick.btn_8.whenPressed(new CascadeMove(new SN_DoublePreference("cargoPos3", 61.0)));
		manipulatorStick.btn_9.whenPressed(new CascadeMove(new SN_DoublePreference("hatchPos2", 28.0)));
		manipulatorStick.btn_10.whenPressed(new CascadeMove(new SN_DoublePreference("cargoPos2", 43.0)));
		manipulatorStick.btn_11.whenPressed(new CascadeMove(new SN_DoublePreference("hatchPos1", 5.0)));
